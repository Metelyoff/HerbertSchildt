package chapter13_io_applets.input_output;
...
class ShowFileTryWithResource {
	public static void main(String args[]) {
		...
		/*
		 * try(FileInputStream fin = new FileInputStream(args[0])) { do { i =
		 * fin.read(); if(i != -1) System.out.print((char) i); } while(i != -1);
		 * 
